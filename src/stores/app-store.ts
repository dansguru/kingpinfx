...
export default class AppStore {
    ...
    getErrorForNonEuClients = () => ({
        ...
        title: localize('KingpinFX Bot is unavailable for this account'),
    ...
    getErrorForEuClients = (is_logged_in = false, country: string | undefined = undefined) => {
        return {
            text: ' ',
            title: is_logged_in
                ? localize(`KingpinFX Bot is not available for ${country || 'EU'} clients`)
                : localize(`KingpinFX Bot is unavailable in ${country || 'the EU'}`),
