...
export default class RunPanelStore {
    ...
    showRealAccountDialog = () => {
        ...
        this.dialog_options = {
            title: localize("KingpinFX Bot isn't quite ready for real accounts"),
            message: localize('Please switch to your demo account to run your KingpinFX Bot.'),
        };
        this.is_dialog_open = true;
    };
    ...
    showIncompatibleStrategyDialog = () => {
        ...
        this.dialog_options = {
            ...
            message: localize('This strategy is currently not compatible with KingpinFX Bot.'),
        };
        this.is_dialog_open = true;
    };
